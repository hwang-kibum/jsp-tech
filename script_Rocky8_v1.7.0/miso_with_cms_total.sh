...
sudo sh -c 'cat '${miso_path}'/webapps/WEB-INF/classes/database/mysql/1_MYSQL_DDL_2_Table.sql >> 07.add.sql'
sudo sh -c 'cat '${miso_path}'/webapps/WEB-INF/classes/database/mysql/2_MYSQL_DDL_3_PK.sql >> 07.add.sql'
sudo sh -c 'cat '${miso_path}'/webapps/WEB-INF/classes/database/mysql/3_MYSQL_DDL_5_INDEX.sql >> 07.add.sql'
sudo sh -c 'cat '${miso_path}'/webapps/WEB-INF/classes/database/mysql/4_MYSQL_DML_1_initData.sql >> 07.add.sql'
sudo sh -c 'cat '${miso_path}'/webapps/WEB-INF/classes/database/mysql/5_MENU_AUTH_DML.sql >> 07.add.sql'
sudo sh -c 'cat '${miso_path}'/webapps/WEB-INF/classes/database/mysql/6_CODE_DML.sql >> 07.add.sql'
sudo sh -c 'cat '${miso_path}'/webapps/WEB-INF/classes/database/mysql/7_MESSAGE_DML.sql >> 07.add.sql'
sudo sh -c 'cat '${miso_path}'/webapps/WEB-INF/classes/database/mysql/8_PEROPERTY_DML.sql >> 07.add.sql'
sudo sh -c 'cat '${miso_path}'/webapps/WEB-INF/classes/database/mysql/9_MAIL_TEMPLATE_BOARD_DML.sql >> 07.add.sql'
sudo sh -c 'cat '${miso_path}'/webapps/WEB-INF/classes/database/mysql/31_MYSQL_CMS_DML_NEW.sql >> 07.add.sql'
sudo sh -c 'cat '${miso_path}'/webapps/WEB-INF/classes/database/mysql/32_MYSQL_DML_NEW.sql >> 07.add.sql'
...
sudo cp ${miso_path}/webapps_${current_date}_bak/WEB-INF/classes/database/mysql/98_MYSQL_DDL_6_ALTER.sql ${miso_path}/webapps_${current_date}_bak/WEB-INF/classes/database/mysql/old_ALTER.sql
sudo cp ${miso_path}/webapps/WEB-INF/classes/database/mysql/98_MYSQL_DDL_6_ALTER.sql ${miso_path}/webapps/WEB-INF/classes/database/mysql/new_ALTER.sql
...
printf "\n\n" >> ../patch/patch.sql
cat ${miso_path}/webapps/WEB-INF/classes/database/mysql/5_MUNU_AUTH_DML.sql  >> ../patch/patch.sql
printf "\n\n" >> ../patch/patch.sql
cat ${miso_path}/webapps/WEB-INF/classes/database/mysql/6_CODE_DML.sql  >> ../patch/patch.sql
printf "\n\n" >> ../patch/patch.sql
cat ${miso_path}/webapps/WEB-INF/classes/database/mysql/7_MESSAGE_DML.sql  >> ../patch/patch.sql
